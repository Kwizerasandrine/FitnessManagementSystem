...
public class UserController {
	...
	@RequestMapping("/by-location/{locationId}")
	public ResponseEntity<?> getUsersByLocation(@PathVariable int locationId) {
		List<User> users = tableUserService.getUsersByLocationId(locationId);
		return Response.success(users);
	}
	
	@RequestMapping("/by-province-code/{code}")
	public ResponseEntity<?> getUsersByProvinceCode(@PathVariable String code) {
		List<User> users = tableUserService.getUsersByProvinceCode(code);
		return Response.success(users);
	}
	
	@RequestMapping("/by-province-name/{name}")
	public ResponseEntity<?> getUsersByProvinceName(@PathVariable String name) {
		List<User> users = tableUserService.getUsersByProvinceName(name);
		return Response.success(users);
	}
}
