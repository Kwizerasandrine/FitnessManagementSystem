...
public class AdminController {
	...
	public ResponseEntity<?> getAllPlans() {
		...
		List<PlanDto> plans = list.stream().map(plan -> PlanDto.fromEntity(plan)).collect(Collectors.toList());
	...
	public ResponseEntity<?> getAllUsers() {
		...
		List<Credentials> allusers = list.stream().map(user -> Credentials.allDataTODto(user))
	...
	public ResponseEntity<?> getAllInventoryItems() {
		...
		List<InventoryDto> items = list.stream().map(item -> InventoryDto.fromEntity(item))
				.collect(Collectors.toList());
