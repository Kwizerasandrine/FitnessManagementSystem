...
const ForgotPassword = () => {
    ...
    return (
        <div className='container'>
            <form style={{ maxWidth: '500px', margin: '100px auto 0' }}>
                <div className='form-group' style={{ textAlign: 'center', marginBottom: '30px' }}>
                    <h1 style={{ fontSize: '32px', fontWeight: 'bold' }}>Forgot Password</h1>
                </div>
                ...
                <div className='form-group' style={{ maxWidth: '400px', margin: '0 auto 20px' }}>
                    ...
                    <input
                        ...
                        value={questionans}
                        onChange={onChangequestionans}
                    />
                </div>

                <div className='form-group' style={{ maxWidth: '400px', margin: '30px auto 0', textAlign: 'center' }}>
                    <button
